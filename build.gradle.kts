...
dependencies {
  dokka(project(":lib:vietmap-compose:"))
  dokka(project(":lib:vietmap-compose-expressions:"))
  dokka(project(":lib:vietmap-compose-material3:"))
  "dokka"(project(":lib:kotlin-vietmap-js"))
