...
import dev.sargunv.vietmapcompose.compose.engine.rememberStyleComposition
import dev.sargunv.vietmapcompose.core.CameraMoveReason
...
import dev.sargunv.vietmapcompose.core.StandardMaplibreMap
import dev.sargunv.vietmapcompose.core.Style
 ...
 *   [LineLayer][dev.sargunv.vietmapcompose.compose.layer.LineLayer]. However, this callback is
 ...
 * - [rememberGeoJsonSource][dev.sargunv.vietmapcompose.compose.source.rememberGeoJsonSource] (see
 *   [GeoJsonSource][dev.sargunv.vietmapcompose.core.source.GeoJsonSource]),
 * - [rememberVectorSource][dev.sargunv.vietmapcompose.compose.source.rememberVectorSource] (see
 *   [VectorSource][dev.sargunv.vietmapcompose.core.source.VectorSource]),
 * - [rememberRasterSource][dev.sargunv.vietmapcompose.compose.source.rememberRasterSource] (see
 *   [RasterSource][dev.sargunv.vietmapcompose.core.source.RasterSource])
 *
 * A source that is already defined in the base map style can be referenced via
 * [getBaseSource][dev.sargunv.vietmapcompose.compose.source.getBaseSource].
 *
 ...
 * - [BackgroundLayer][dev.sargunv.vietmapcompose.compose.layer.BackgroundLayer]
 * - [LineLayer][dev.sargunv.vietmapcompose.compose.layer.LineLayer]
 * - [FillExtrusionLayer][dev.sargunv.vietmapcompose.compose.layer.FillExtrusionLayer]
 * - [FillLayer][dev.sargunv.vietmapcompose.compose.layer.FillLayer]
 * - [HeatmapLayer][dev.sargunv.vietmapcompose.compose.layer.HeatmapLayer]
 * - [HillshadeLayer][dev.sargunv.vietmapcompose.compose.layer.HillshadeLayer]
 * - [LineLayer][dev.sargunv.vietmapcompose.compose.layer.LineLayer]
 * - [RasterLayer][dev.sargunv.vietmapcompose.compose.layer.RasterLayer]
 * - [SymbolLayer][dev.sargunv.vietmapcompose.compose.layer.SymbolLayer]
 *
 ...
 * - [Anchor.Top][dev.sargunv.vietmapcompose.compose.layer.Anchor.Companion.Top],
 * - [Anchor.Bottom][dev.sargunv.vietmapcompose.compose.layer.Anchor.Companion.Bottom],
 * - [Anchor.Above][dev.sargunv.vietmapcompose.compose.layer.Anchor.Companion.Above],
 * - [Anchor.Below][dev.sargunv.vietmapcompose.compose.layer.Anchor.Companion.Below],
 * - [Anchor.Replace][dev.sargunv.vietmapcompose.compose.layer.Anchor.Companion.Replace],
 * - [Anchor.At][dev.sargunv.vietmapcompose.compose.layer.Anchor.Companion.At]
 */
@Composable
