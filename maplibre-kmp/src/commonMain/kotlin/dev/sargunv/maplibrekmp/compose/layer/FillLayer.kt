...
/**
 * A fill layer draws polygons from the [sourceLayer] in the given [source] in the
 * given style as a series of polygon fills. If nothing else is specified, these will be black.
 *
 * @param id
 *   Unique layer name.
 *
